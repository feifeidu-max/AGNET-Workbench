...
profileRoutes.post('/api/hermes/profiles/:name/gateway/start', ctrl.startGatewayForProfile)
profileRoutes.post('/api/hermes/profiles/:name/gateway/stop', ctrl.stopGatewayForProfile)
