...
export type SessionMemoryMode = 'on' | 'clean'
...
export async function setSessionMemoryMode(id: string, memoryMode: SessionMemoryMode): Promise<boolean> {
  try {
    await request(`/api/hermes/sessions/${id}/memory-mode`, {
      method: 'POST',
