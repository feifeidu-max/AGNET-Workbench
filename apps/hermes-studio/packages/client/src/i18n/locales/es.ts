export default {
  ...
  login: {
    ...
    defaultCredentialTitle: 'Cambia la contrasena predeterminada',
    defaultCredentialMessage: 'Esta cuenta aun usa la contrasena predeterminada. Cambiala antes de continuar al espacio de trabajo.',
  ...
  chat: {
    ...
    memoryMode: {
      ...
      on: 'Memoria activa',
      clean: 'Contexto limpio',
      onHint: 'Hermes puede usar MEMORY.md y USER.md.',
      cleanHint: 'Se excluyen MEMORY.md y USER.md; SOUL.md y el contexto del espacio de trabajo permanecen.',
      switchHint: 'Cambia antes del primer mensaje.',
      lockedHint: 'El modo de memoria se bloquea después del primer mensaje. Crea una sesión nueva para cambiarlo.',
      updateFailed: 'No se pudo actualizar el modo de memoria.',
    },
...
jobTriggered: 'Job ejecutado',
  ...
  memory: {
    ...
    publicModelWarning: 'El modo de memoria envía MEMORY.md y USER.md al modelo público configurado. No guardes datos sensibles.',
    revisionConflict: 'Esta memoria cambió en otro lugar. Se cargó la versión más reciente; revísala y vuelve a guardar.',
    characterBudget: 'Presupuesto de caracteres',
