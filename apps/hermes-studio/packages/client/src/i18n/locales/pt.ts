export default {
  ...
  login: {
    ...
    defaultCredentialTitle: 'Altere a senha padrao',
    defaultCredentialMessage: 'Esta conta ainda usa a senha padrao. Altere-a antes de continuar para o espaco de trabalho.',
  ...
  chat: {
    ...
    memoryMode: {
      title: 'Modo de memória',
      on: 'Memória ativa',
      clean: 'Contexto limpo',
      onHint: 'Hermes pode usar MEMORY.md e USER.md.',
      cleanHint: 'MEMORY.md e USER.md são excluídos; SOUL.md e o contexto do espaço de trabalho permanecem.',
      switchHint: 'Alterne antes da primeira mensagem.',
      lockedHint: 'O modo de memória é bloqueado após a primeira mensagem. Crie uma nova sessão para alterá-lo.',
      updateFailed: 'Não foi possível atualizar o modo de memória.',
    },
...
jobTriggered: 'Job acionado',
  ...
  memory: {
    ...
    publicModelWarning: 'O modo de memória envia MEMORY.md e USER.md ao modelo público configurado. Não guarde dados sensíveis.',
    revisionConflict: 'Esta memória mudou em outro local. A versão mais recente foi carregada; reveja e guarde novamente.',
    characterBudget: 'Limite de caracteres',
    effectiveStatus: 'Estado efetivo',
    enabled: 'ativado',
    disabled: 'desativado',
  },
