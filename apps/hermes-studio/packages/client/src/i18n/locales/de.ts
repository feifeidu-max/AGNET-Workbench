export default {
  ...
  login: {
    ...
    defaultCredentialTitle: 'Standardpasswort andern',
    defaultCredentialMessage: 'Dieses Konto verwendet noch das Standardpasswort. Andern Sie es, bevor Sie die Arbeitsoberflache weiter verwenden.',
  ...
  chat: {
    ...
    memoryMode: {
      title: 'Speichermodus',
      on: 'Speicher aktiv',
      clean: 'Sauberer Kontext',
      onHint: 'Hermes kann MEMORY.md und USER.md verwenden.',
      cleanHint: 'MEMORY.md und USER.md werden ausgeschlossen; SOUL.md und Arbeitskontext bleiben erhalten.',
      switchHint: 'Vor der ersten Nachricht umschalten.',
      lockedHint: 'Der Speichermodus ist nach der ersten Nachricht gesperrt. Erstellen Sie eine neue Sitzung zum Ändern.',
      updateFailed: 'Speichermodus konnte nicht aktualisiert werden.',
    },
...
jobTriggered: 'Job ausgelost',
  ...
  memory: {
    ...
    publicModelWarning: 'Der aktive Speichermodus sendet MEMORY.md und USER.md an das konfigurierte öffentliche Modell. Keine sensiblen Daten speichern.',
    revisionConflict: 'Diese Erinnerung wurde an anderer Stelle geändert. Die neueste Version wurde geladen; bitte prüfen und erneut speichern.',
    characterBudget: 'Zeichenbudget',
