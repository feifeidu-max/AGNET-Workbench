export default {
  ...
  login: {
    ...
    defaultCredentialTitle: 'Change the default password',
    defaultCredentialMessage: 'This account is still using the default password. Change it before continuing to the workbench.',
  ...
  chat: {
    ...
    memoryMode: {
      ...
      on: 'Memory on',
      clean: 'Clean context',
      onHint: 'Long-term MEMORY.md and USER.md are available to Hermes.',
      cleanHint: 'MEMORY.md and USER.md are excluded; SOUL.md and workspace context remain.',
      switchHint: 'Click to switch before the first message.',
      lockedHint: 'Memory mode is locked after the first message. Create a new session to change it.',
      updateFailed: 'Unable to update memory mode.',
    },
  ...
  memory: {
    ...
    publicModelWarning: 'Memory on sends MEMORY.md and USER.md to the configured public model. Keep sensitive data out of these files.',
    revisionConflict: 'This memory changed elsewhere. The latest version was loaded; review and save again.',
    history: 'Version history',
    historyLoadFailed: 'Failed to load version history',
    noHistory: 'No saved versions yet.',
    currentRevision: 'Current',
    restore: 'Restore',
    restoreConfirm: 'Restore this version as a new revision?',
  ...
  settings: {
    ...
    models: {
      ...
      sensenova: {
        ...
        endpointPlaceholder: 'https://token.sensenova.cn/v1',
        apiKey: 'API key',
        keyPlaceholder: 'Enter the SenseNova API key',
        keyConfigured: 'Configured ({hint}); leave blank to keep it',
        keyHint: 'A new key replaces the current key. Leave this field blank to keep the existing key.',
        model: 'Default model',
        modelPlaceholder: 'Choose a fetched model or enter a model ID',
        test: 'Test connection',
        save: 'Save connection',
        testing: 'Testing connection…',
        saving: 'Saving…',
        testSuccess: 'Connection ready; found {count} models',
        testReady: 'SenseNova is reachable and the model list was loaded.',
        testFailed: 'The SenseNova connection failed. Check the URL, key, and network.',
        loadFailed: 'Failed to load SenseNova settings',
        saveSuccess: 'SenseNova connection saved',
        saveFailed: 'Failed to save SenseNova settings',
        required: 'Endpoint URL and model are required',
        modelUnavailable: 'The selected model was not returned by the endpoint; it can still be saved if the provider supports it.',
      },
    },
    display: {
