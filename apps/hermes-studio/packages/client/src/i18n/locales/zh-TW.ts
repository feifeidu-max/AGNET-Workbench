export default {
  ...
  login: {
    ...
    defaultCredentialTitle: '請修改預設密碼',
    defaultCredentialMessage: '目前登入帳號仍在使用預設密碼。為避免未授權存取，必須先修改密碼才能繼續使用工作台。',
  ...
  chat: {
    ...
    memoryMode: {
      ...
      on: '開啟記憶',
      clean: '乾淨上下文',
      onHint: 'Hermes 可讀取長期 MEMORY.md 與 USER.md。',
      cleanHint: '排除 MEMORY.md 與 USER.md，但保留 SOUL.md 和工作區上下文。',
      switchHint: '首則訊息前可點擊切換。',
      lockedHint: '首則訊息後記憶模式已鎖定，請建立新工作階段後更改。',
      updateFailed: '記憶模式更新失敗。',
    },
  ...
  memory: {
    ...
    publicModelWarning: '開啟記憶會將 MEMORY.md 與 USER.md 傳給設定的公用模型，請勿寫入敏感資訊。',
    revisionConflict: '記憶已在其他位置修改，已載入最新版本，請確認後重新儲存。',
    history: '版本歷史',
    historyLoadFailed: '載入版本歷史失敗',
    noHistory: '暫無已儲存版本。',
    currentRevision: '目前版本',
    restore: '還原',
    restoreConfirm: '確認將此版本還原為一個新版本嗎？',
    restoreSuccess: '版本已還原',
    restoreFailed: '還原版本失敗',
    characterBudget: '字元預算',
    effectiveStatus: '生效狀態',
    enabled: '已啟用',
    disabled: '已停用',
  },
