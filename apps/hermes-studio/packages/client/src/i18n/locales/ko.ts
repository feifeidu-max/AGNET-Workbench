export default {
  ...
  login: {
    ...
    defaultCredentialTitle: '기본 비밀번호를 변경하세요',
    defaultCredentialMessage: '이 계정은 아직 기본 비밀번호를 사용하고 있습니다. 작업 공간을 계속 사용하기 전에 비밀번호를 변경하세요.',
  ...
  chat: {
    ...
    memoryMode: {
      ...
      on: '메모리 사용',
      clean: '클린 컨텍스트',
      onHint: 'Hermes가 MEMORY.md와 USER.md를 사용할 수 있습니다.',
      cleanHint: 'MEMORY.md와 USER.md를 제외하고 SOUL.md와 작업공간 컨텍스트는 유지합니다.',
      switchHint: '첫 메시지 전에 전환할 수 있습니다.',
      lockedHint: '첫 메시지 후에는 잠깁니다. 변경하려면 새 세션을 만드세요.',
      updateFailed: '메모리 모드를 업데이트하지 못했습니다.',
    },
  ...
  memory: {
    ...
    publicModelWarning: '메모리를 켜면 MEMORY.md와 USER.md가 공개 모델로 전송됩니다. 민감한 정보를 저장하지 마세요.',
    revisionConflict: '메모리가 다른 곳에서 변경되었습니다. 최신 버전을 불러왔습니다. 확인 후 다시 저장하세요.',
    characterBudget: '문자 예산',
