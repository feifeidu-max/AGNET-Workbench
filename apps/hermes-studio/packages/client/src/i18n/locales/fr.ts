export default {
  ...
  login: {
    ...
    defaultCredentialTitle: 'Modifiez le mot de passe par defaut',
    defaultCredentialMessage: 'Ce compte utilise encore le mot de passe par defaut. Modifiez-le avant de continuer vers l espace de travail.',
  ...
  chat: {
    ...
    memoryMode: {
      title: 'Mode mémoire',
      on: 'Mémoire active',
      clean: 'Contexte propre',
      onHint: 'Hermes peut utiliser MEMORY.md et USER.md.',
      cleanHint: 'MEMORY.md et USER.md sont exclus; SOUL.md et le contexte de travail restent disponibles.',
      switchHint: 'Changez avant le premier message.',
      lockedHint: 'Le mode mémoire est verrouillé après le premier message. Créez une nouvelle session pour le changer.',
      updateFailed: 'Impossible de mettre à jour le mode mémoire.',
    },
...
jobTriggered: 'Job declenche',
  ...
  memory: {
    ...
    publicModelWarning: 'Le mode mémoire envoie MEMORY.md et USER.md au modèle public configuré. N’y stockez aucune donnée sensible.',
    revisionConflict: 'Cette mémoire a changé ailleurs. La dernière version a été chargée; vérifiez puis enregistrez à nouveau.',
    characterBudget: 'Budget de caractères',
    effectiveStatus: 'État effectif',
    enabled: 'activé',
    disabled: 'désactivé',
  },
