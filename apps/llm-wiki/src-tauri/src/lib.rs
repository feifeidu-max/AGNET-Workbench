...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ingest_gate::stage_ingest_source,
            ingest_gate::stage_generated_wiki_page,
            ingest_gate::pending_ingest_publications,
            ingest_gate::set_ingest_embedding_status,
            ingest_gate::claim_ingest_compilation,
            ingest_gate::submit_ingest_compilation,
            ingest_gate::fail_ingest_compilation,
            set_proxy_env,
            set_close_behavior,
        ])
